...
#apt-get upgrade --yes
apt-get install --yes --no-install-recommends aptitude zsh git vim rsync python-cups python-pip cups-daemon cups cups-filters foomatic-db-compressed-ppds foomatic-db-engine python printer-driver-hpcups printer-driver-gutenprint htop tmux python3-cups python3-pip
